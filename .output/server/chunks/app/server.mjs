...
const _routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-Si9L4-Oy.mjs').then((m) => m.default || m)
      },
      {
      ...
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-R39Drsz0.mjs').then((m) => m.default || m)
      },
      {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/base-JHMq566h.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-77o2T2nT.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-SP9CEURW.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-2mpKm0hx.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
