import { _ as __nuxt_component_0$1 } from "./client-only-uY1C8Tgt.js";
import { mergeProps, useSSRContext, defineComponent, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, ref, Transition, createCommentVNode, withDirectives, isRef, vModelText, Fragment, renderList, nextTick } from "vue";
import { r as useSeoMeta } from "../server.mjs";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderList } from "vue/server-renderer";
...
import { _ as _sfc_main$9 } from "./TheButton-Jrv5tshN.js";
import { _ as _sfc_main$a } from "./TheModal-1X0PcTyA.js";
import { _ as _sfc_main$b } from "./TheFileInput-J7OnVKdf.js";
import { Preview } from "vue-advanced-cropper";
import { _ as __nuxt_component_0 } from "./nuxt-link-nvHjMUuE.js";
import { S as Sceleton } from "./TheSceleton-RMAy-i6X.js";
import { _ as _sfc_main$c } from "./TheChatAvatar-s-0p0zbn.js";
...
const ChatNavHeaderSlot = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender]]);
        ...
        _push(ssrRenderComponent(_sfc_main$a, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$b, { toward: unref(chat) }, null, _parent2, _scopeId));
              ...
              _push2(`</div><div${_scopeId}><p class="text-sm tracking-wider text-semiCyan"${_scopeId}>${ssrInterpolate(_ctx.$t("Название группы"))}</p><input${ssrRenderAttr("value", unref(groupTitle))} class="bg-transparent border-b-2 border-b-semiCyan !outline-none" type="text"${_scopeId}></div></div><div class="flex select-none text-sm justify-end gap-x-4"${_scopeId}>`);
              ...
              return [
                createVNode("div", {
                  ...
                  createVNode("div", {
                    ...
                    createVNode(Transition, { name: "fade" }, {
                      default: withCtx(() => [
                        createVNode(_sfc_main$b, { toward: unref(chat) }, null, 8, ["toward"])
                      ]),
                      _: 1
                    }),
                  ...
                  createVNode("div", null, [
                    ...
                    withDirectives(createVNode("input", {
                      ...
                      class: "bg-transparent border-b-2 border-b-semiCyan !outline-none",
                      type: "text"
                ...
                createVNode("div", {
                  onClick: ($event) => setFocus(),
                  class: "flex select-none text-sm justify-end gap-x-4"
                }, [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(unref(chat).get_chat_list.results.filter((e) => !e.is_group), (item) => {
                _push2(ssrRenderComponent(_sfc_main$6, { item }, null, _parent2, _scopeId));
              });
              ...
              if (!unref(chat).showSettingChat) {
                ...
                _push2(ssrRenderComponent(_sfc_main$9, {
                  type: "chat",
                  onClick: ($event) => unref(chat).showGroupCreateChoice = false
                }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(_ctx.$t("Отмена"))}`);
              ...
              return [
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(chat).get_chat_list.results.filter((e) => !e.is_group), (item) => {
                  return openBlock(), createBlock(_sfc_main$6, { item }, null, 8, ["item"]);
                }), 256)),
                createVNode("div", { class: "w-full px-4 h-[50px] flex items-center justify-end text-sm gap-x-4" }, [
                  !unref(chat).showSettingChat ? (openBlock(), createBlock(_sfc_main$9, {
                    key: 0,
                    type: "chat",
                    onClick: ($event) => {
                      unref(chat).showGroupCreateChoice = false;
                    ...
                    _: 1
                  }, 8, ["onClick"])) : (openBlock(), createBlock(_sfc_main$9, {
                    key: 1,
                    type: "chat",
                    onClick: ($event) => unref(chat).showGroupCreateChoice = false
                  }, {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            onClick: ($event) => {
              ...
              userSearchList.id !== ((_a = unref(chatStore).get_user_chat.user) == null ? void 0 : _a.id) ? unref(chatStore).createChatUser({ user_id: userSearchList.id }) : () => {
                ...
                _ctx.router.push(`/base/chat/${(_a2 = unref(chatStore).get_user_chat) == null ? void 0 : _a2.id}`);
              };
              unref(chatStore).showPinnedWindow = false;
...
//# sourceMappingURL=chat-v1rO-_t2.js.map
