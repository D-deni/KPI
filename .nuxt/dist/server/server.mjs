import { hasInjectionContext, getCurrentInstance, effectScope, reactive, version, unref, inject, ref, watchEffect, watch, toRef as toRef$1, h, nextTick, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, isShallow, defineAsyncComponent, toValue as toValue$1, defineComponent, onUnmounted, Fragment, createVNode, Text, provide, Suspense, Transition, readonly, customRef, mergeProps, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
        ...
        children: [
          {
            ...
            alias: [],
            redirect: void 0,
            component: () => import("./_nuxt/_id_-Wlj_cIO2.js").then((m) => m.default || m)
          }
        ],
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/chat-v1rO-_t2.js").then((m) => m.default || m)
      },
      {
        name: "base-cloud",
        path: "cloud",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-BgdBmkKw.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-tQiCb7Vy.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-x5sV8Nqx.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-FJDNBKqC.js").then((m) => m.default || m)
      },
      {
        name: "base-companies",
        path: "companies",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-s23hEhpk.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-RWLYg24Z.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-Si9L4-Oy.js").then((m) => m.default || m)
      },
      {
        name: "base-documents-id",
        path: "documents/:id()",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-RKOfK9i7.js").then((m) => m.default || m)
      },
      {
        name: "base-documents",
        path: "documents",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-YVAhFsqz.js").then((m) => m.default || m)
      },
      {
        name: "base-graph",
        path: "graph",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-R39Drsz0.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-lXQQpl4F.js").then((m) => m.default || m)
      },
      {
        name: "base-objects",
        path: "objects",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-DB2AWASO.js").then((m) => m.default || m)
      },
      {
        name: "base-profile",
        path: "profile",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/profile-WeBSzQcV.js").then((m) => m.default || m)
      },
      {
        name: "base-tasks-id",
        path: "tasks/:id()",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-9ch-LTiO.js").then((m) => m.default || m)
      },
      {
        name: "base-tasks",
        path: "tasks",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-9aYi-h8K.js").then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/exam-wbiS321z.js").then((m) => m.default || m)
      },
      {
        name: "base-tests",
        path: "tests",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-6b-Nc0XY.js").then((m) => m.default || m)
      },
      {
        name: "base-tree",
        path: "tree",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-AYuGKCxK.js").then((m) => m.default || m)
      },
      {
        name: "base-users-id",
        path: "users/:id()",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/_id_-t7sRrRol.js").then((m) => m.default || m)
      },
      {
        name: "base-users",
        path: "users",
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/index-FCvtq4Bk.js").then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/base-F6kPUp9H.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-uw1Lgw1N.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  authorized: () => import("./_nuxt/authorized-Xl04PIoU.js")
};
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-8OpWvKRl.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-Xex4C6y3.js").then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-77o2T2nT.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-SP9CEURW.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-2mpKm0hx.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
