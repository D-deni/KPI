...
<template>
  <NuxtLink :to=" from ? route.path + `/${item.slug}/${item.id}` : route.path + `/${item.id}`" class="hover:bg-blueSemiLight hover:text-white transition-all h-max duration-200 p-2 rounded-xl w-[200px] ">
