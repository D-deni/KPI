...
<template>
    <UTooltip class="text-lg tracking-wider" :text="$t('Отсканируйте код')" :popper="{arrow: true}">
      <button class="relative border dark:border-gray-400 rounded-lg p-1 transition-all" :class="{'dark:border-gray-200 border-gray-400' : mode === 'scan'}" @click="this.$emit('onScan')" >
