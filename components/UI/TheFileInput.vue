...
<template>
  <label for="uploadImage">
    <div v-if="!chat.file_image" class="p-4 rounded-full hover:bg-semiCyan bg-blueSemiLight transition-all duration-200 cursor-pointer">
    ...
    <div v-else class="">
      <img class="rounded-full w-[72px] h-[72px]" :src="chat.file_image" alt="">
    </div>
    <input
      id="uploadImage"
      :value="modelValue"
