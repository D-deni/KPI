    ...
    <div
      ...
      <div class="w-2/12 max-md:w-full flex max-md:justify-center items-center gap-x-2">
        <div class="cursor-pointer relative transition-all" @mouseenter="moveElem = true"
          ...
          <div
            class="absolute dark:bg-gray-400 bg-white w-[200px] max-md:left-0 right-0 top-10 z-10 shadow-md rounded-lg p-2"
            :class="{'hidden' : !moveElem, 'block' : moveElem}">
      ...
      <TheModal @showModal="showFilter = !showFilter" v-if="showFilter">
        <div>
          ...
          <div class="flex justify-between mx-auto my-10 max-lg:flex-col items-center gap-y-10">
            ...
            <TaskFilter class="p-4" :class="{'box' : showStatus ==='chart'}"
                        @showEvent="showStatus = !showStatus; showStatus = 'chart'">
              <template v-slot:filterIcon>
                <svg width="25px" class="stroke-black dark:stroke-white" height="25px" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 18V9" stroke-width="1.5" stroke-linecap="round"/>
                  <path d="M12 18V6" stroke-width="1.5" stroke-linecap="round"/>
                  <path d="M17 18V13" stroke-width="1.5" stroke-linecap="round"/>
                  <path
              ...
              <template v-slot:filterChevron>
                <svg class="transition-all dark:stroke-white stroke-black"
                     :class="{'rotate-180' : showStatus === 'chart'}" width="25px" height="25px" viewBox="0 0 24 24"
                     fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 9.5L12 14.5L7 9.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </template>
          ...
          <div>
            <div v-if="showStatus === 'status'">
              <div
                class="flex justify-between dark:text-white tracking-widest max-sm:flex-col flex-wrap max-sm:flex-nowrap">
            ...
            <div v-if="showStatus === 'name'">
              Lorem ipsum dolor sit amet, c
            </div>
            <div class="flex items-center justify-center mx-auto w-full" v-if="showStatus === 'date'">
          ...
          <div class="flex justify-evenly my-10">
            ...
            <TheButton type="button" class="w-3/12 max-sm:w-5/12  py-2 rounded-lg bg-semiCyan">Поиск</TheButton>
          </div>
        </div>
      </TheModal>
    </div>
